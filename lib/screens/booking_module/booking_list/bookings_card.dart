...
class BookingsCard extends StatelessWidget {
  ...
  BookingsCard({super.key, this.isfromBookings = false, this.onUpdateBooking, required this.booking});
        ...
        children: [
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              if (booking.status.contains(BookingStatusConst.PENDING) || booking.status.contains(BookingStatusConst.CONFIRMED) || booking.status.contains(BookingStatusConst.INPROGRESS)) ...[
                8.height,
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    if (booking.status.contains(BookingStatusConst.PENDING))
                      AppButton(
                          ...
                          onTap: () {
                            ...
                            }, dialogType: DialogType.DELETE, title: "${locale.value.doYouWantToConfirmBooking}?");
                          }).expand(),
